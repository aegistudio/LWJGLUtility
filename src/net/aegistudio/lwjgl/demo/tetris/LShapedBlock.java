...
public class LShapedBlock extends Block
{
	...
	public LShapedBlock(Tetris tetris, int positionx, int positiony, int orientation)
	{
	...
	public boolean caninitialize()
	{
		...
		switch(this.orientation)
		{
			case 0:
				...
				break;
			case 1: if(super.tetris.isTetrisBlock(super.masscenterx - 1, super.masscentery)) return false; break;
			default:
				break;
		}
		return true;
	...
	public void moveleft()
	{
		...
		switch(this.orientation)
		{
			case 1:
				...
				if(super.tetris.isTetrisBlock(super.masscenterx - 2 , super.masscentery + 2)) shouldmoveleft = false;
				break;
			case 2:
	...
	public void moveright()
	{
		...
		switch(this.orientation)
		{
			case 1:
				...
				if(super.tetris.isTetrisBlock(super.masscenterx , super.masscentery + 1)) shouldmoveright = false;
				if(super.tetris.isTetrisBlock(super.masscenterx , super.masscentery + 2)) shouldmoveright = false;
				break;
			case 2:
				if(super.tetris.isTetrisBlock(super.masscenterx + 1 , super.masscentery)) shouldmoveright = false;
				if(super.tetris.isTetrisBlock(super.masscenterx + 3 , super.masscentery + 1)) shouldmoveright = false;
				break;
			case 3:
				if(super.tetris.isTetrisBlock(super.masscenterx + 1 , super.masscentery)) shouldmoveright = false;
